/*******************************************************************************
 * @file    pair_chat_server.c
 * @brief   Ứng dụng Chat nhóm 2 người (ghép cặp) sử dụng kỹ thuật Multithread
 * @date    2026-05-24
 *******************************************************************************/
...
int main() {
    ...
    while (1) {
        ...
        if (waiting_client == -1) {
            ...
            char *start_msg = "Ghep cap thanh cong! Ban dau co the chat nhom 2 nguoi.\n";
